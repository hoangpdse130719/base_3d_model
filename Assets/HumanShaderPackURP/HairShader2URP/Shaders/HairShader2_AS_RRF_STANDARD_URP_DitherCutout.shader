	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 normalizeResult246 = ASESafeNormalize( ( appendResult241 + float4( WorldViewDirection , 0.0 ) ) );
				...
				float3 objToWorldDir343 = ASESafeNormalize( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord9.xyz, 0 ) ).xyz );
				float3 normalizeResult345 = ASESafeNormalize( objToWorldDir343 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 clampResult473 = clamp( temp_output_268_0 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 appendResult241 = (float4(SafeNormalize(_MainLightPosition.xyz).x , ( ( _SecondaryHighlightPosition + NoiseFX312 ) + SafeNormalize(_MainLightPosition.xyz).y ) , SafeNormalize(_MainLightPosition.xyz).z , 0.0));
				float4 normalizeResult246 = ASESafeNormalize( ( appendResult241 + float4( ase_worldViewDir , 0.0 ) ) );
				float4 HL2247 = normalizeResult246;
				float dotResult249 = dot( HL2247 , float4( T200 , 0.0 ) );
				float DotTHL2252 = dotResult249;
				float sinTHL2256 = sqrt( ( 1.0 - ( DotTHL2252 * DotTHL2252 ) ) );
				...
				float3 objToWorldDir343 = ASESafeNormalize( mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord7.xyz, 0 ) ).xyz );
				float3 normalizeResult345 = ASESafeNormalize( objToWorldDir343 );
				float dotResult346 = dot( SafeNormalize(_MainLightPosition.xyz) , normalizeResult345 );
				float clampResult353 = clamp( ( ( ( dotResult346 + _Light_Bias ) * _Light_Scale ) * _LightScatter ) , 0.0 , 1.0 );
				float SSS_Effect394 = ( _BaseIllumination * _SSS * clampResult353 );
...
Node;AmplifyShaderEditor.SamplerNode;335;-2810.142,-610.1206;Inherit;True;Property;_BaseTexture;BaseTexture;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.NormalizeNode;345;49.59906,1414.142;Inherit;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TransformDirectionNode;343;-225.4491,1401.88;Inherit;False;Object;World;True;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.WorldNormalVector;198;-4653.304,-180.1292;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;17;-3716.658,-771.6227;Float;False;World;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;303;-4161.294,-625.801;Float;False;Property;_MainHighlightPosition;Main Highlight Position;14;0;Create;True;0;0;0;False;0;False;0;0.5;-1;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;246;-2708.667,-1048.994;Inherit;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.LightColorNode;314;-1980.846,337.9113;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;344;-494.3033,1235.426;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.GetLocalVarNode;395;-440.0382,74.39996;Inherit;False;394;SSS_Effect;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;339;-187.033,-117.7688;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=EAF91F939763D571F5B72B8B87EF7E3447392E2F